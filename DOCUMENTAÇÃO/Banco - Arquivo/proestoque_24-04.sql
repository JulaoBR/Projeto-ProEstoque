...
--
-- Host: 127.0.0.1
-- Generation Time: 24-Abr-2018 às 20:57
...
INSERT INTO `cidade` (`cid_cod`, `cid_nome`, `cid_uf`, `cid_ibge`) VALUES
...
CREATE TABLE `cliente` (
  ...
  `cli_cod_origial` int(11) NOT NULL,
  `cli_nome_social` varchar(100) NOT NULL,
  `cli_nome_fantasia` varchar(100) NOT NULL,
...
INSERT INTO `estado` (`est_cod`, `est_nome`, `est_uf`, `est_ibge`, `est_sl`, `est_ddd`) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
CREATE TABLE `produto` (
  ...
  `pro_prazo_validade` int(11) NOT NULL,
  `pro_peso_liquido` decimal(11,0) NOT NULL,
  `pro_peso_bruto` decimal(11,0) NOT NULL,
  `pro_estoque_minimo` decimal(11,0) NOT NULL,
  `pro_estoque_maximo` decimal(11,0) NOT NULL,
  `pro_cod_barra` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `unidade_medida` (
  `uni_cod` int(11) NOT NULL,
  `uni_descricao` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `tipo_produto`
  MODIFY `tipo_cod` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `unidade_medida`
--
ALTER TABLE `unidade_medida`
  MODIFY `uni_cod` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `usuario`
--
ALTER TABLE `usuario`
  MODIFY `usu_cod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `produto`
  ADD CONSTRAINT `produto_ibfk_1` FOREIGN KEY (`tipo_cod`) REFERENCES `tipo_produto` (`tipo_cod`),
  ADD CONSTRAINT `produto_ibfk_2` FOREIGN KEY (`uni_cod`) REFERENCES `unidade_medida` (`uni_cod`);
COMMIT;
